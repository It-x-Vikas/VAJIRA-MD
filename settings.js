...
global.owner = process.env.OWNER_NUMBER  || '923359819830' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || "VAJIRA-MD=jR0yHAzQ#b4dfU-yV2u4I8k_Qufjj2HN32SceIoHrjzGY7pAkqnY",
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923359819830" : process.env.MODERATORS ,    
